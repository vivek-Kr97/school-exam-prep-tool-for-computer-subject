...
export default function Class7() {
  ...
  const startPractice = (type) => {
    navigate(`/practice?class=7&type=${type}`);
  };
  ...
  return (
    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-purple-50 p-4">
      ...
      {/* Hero Section */}
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl p-7 md:p-10 mb-6">
        <h1 className="text-3xl md:text-4xl font-extrabold text-center text-blue-600">
          Class 7 Computer Practice
        </h1>
          ...
          {questionTypes.map((type) => (
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                Practice {type.label} questions for Class 7
              </p>
            </button>
          ))}
        </div>
